...
class TestDisparateImpact:
    ...
    def test_passes_80_rule(self, balanced_data):
        ...
        result = disparate_impact_ratio(balanced_data, "gender", "approved", positive_label=1)
    ...
    def test_fails_80_rule(self, imbalanced_data):
        ...
        result = disparate_impact_ratio(imbalanced_data, "gender", "approved", positive_label=1)
...
class TestGroupLabelRates:
    ...
    def test_rates_calculation(self, imbalanced_data):
        ...
        rates = group_label_rates(imbalanced_data, "gender", "approved", positive_label=1)
