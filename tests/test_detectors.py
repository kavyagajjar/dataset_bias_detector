...
class TestLabelBiasDetector:
    ...
    def test_disparate_impact_detected(self, imbalanced_data):
        ...
        config = AuditConfig(
            protected_attributes=["gender"], target_column="approved", positive_label=1
        )
    ...
    def test_no_label_bias_without_target(self, balanced_data):
        ...
        config = AuditConfig(protected_attributes=["gender"], target_column=None)  # No target
        detector = LabelBiasDetector(config)
...
class TestFeatureProxyDetector:
    ...
    def test_proxy_detected(self, proxy_data):
        ...
        config = AuditConfig(protected_attributes=["gender"], target_column="approved")
...
class TestIntegration:
    ...
    def test_all_detectors_run(self, imbalanced_data):
        ...
        config = AuditConfig(
            protected_attributes=["gender", "race"], target_column="approved", positive_label=1
        )
